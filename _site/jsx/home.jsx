...
var Alchemy = React.createClass({
  ...
  componentDidMount: function() {
    ...
    this.props.weird.style.zIndex = 11;
        this.props.weird3.style.zIndex = 8;
        this.props.weird2.style.zIndex = 8;
        this.props.weird4.style.zIndex = 8;
    this.handleScroll();
  ...
  render: function() {
    ...
    return (
      <div  className="weird" style={{height: window.innerHeight}} onWheel={this.handleScroll} onTouchMove={this.handleTouch}>
        <h1>Coding Alchemy</h1>
        
        <h4>By <a href="https://github.com/rnbwd">RnbWd</a> {this.state.touch}</h4>
        
        <div ref="weird" style={style}  >
          <span style={{marginRight: '10px'}} className="pull-right">{this.props.data[0].date}  </span>
          <h1>{this.props.data[0].title}</h1>
          <a href={baseUrl+this.props.data[0].url}><svg height={height+25} version="1.1" width={width} xmlns="http://www.w3.org/2000/svg" style={{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}>
          <path style={transparent}  ref="triangle" stroke="#2c3e50" d={"M"+middleW+","+(middleH-55)+"L"+(middleW-45*Math.sqrt(3))+","+(middleH+70)+"L"+(middleW+45*Math.sqrt(3))+","+(middleH+70)+"Z"} strokeWidth="3"></path>
          <path style={transparent} ref="tr" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW+45*Math.sqrt(3))-20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="tl" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW-45*Math.sqrt(3))+20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="td" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+(middleW)+","+(middleH+94)} strokeWidth="3"></path>
          <circle style={grey} cx={middleW+45*Math.sqrt(3)} cy={middleH-17} r="20" stroke="#2c3e50" strokeWidth="3" ></circle>
          <circle style={grey} cx={middleW-45*Math.sqrt(3)} cy={middleH-17} r="20" stroke="#2c3e50" strokeWidth="3"></circle>
          <circle style={grey} cx={middleW} cy={middleH+114} r="20" stroke="#2c3e50" strokeWidth="3"></circle>
        </svg></a>
         </div>
         <div ref="weird2" style={style}  >
         <span style={{marginRight: '10px'}} className="pull-right">{this.props.data[1].date}  </span>
            <h1>{this.props.data[1].title}</h1>
            <a href={baseUrl+this.props.data[1].url}><svg height={height+25} version="1.1" width={width} xmlns="http://www.w3.org/2000/svg" style={{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}>
          <path style={transparent}  ref="triangle" stroke="#2c3e50" d={"M"+middleW+","+(middleH-55)+"L"+(middleW-45*Math.sqrt(3))+","+(middleH+70)+"L"+(middleW+45*Math.sqrt(3))+","+(middleH+70)+"Z"} strokeWidth="3"></path>
          <path style={transparent} ref="tr" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW+45*Math.sqrt(3))-20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="tl" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW-45*Math.sqrt(3))+20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="td" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+(middleW)+","+(middleH+94)} strokeWidth="3"></path>
         ...
         <div ref="weird3" style={style}  >
         <span style={{marginRight: '10px'}} className="pull-right">{this.props.data[2].date}  </span>
           <h1>{this.props.data[2].title}</h1>
           <a href={baseUrl+this.props.data[2].url}><svg height={height+25} version="1.1" width={width} xmlns="http://www.w3.org/2000/svg" style={{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}>
          <path style={transparent}  ref="triangle" stroke="#2c3e50" d={"M"+middleW+","+(middleH-55)+"L"+(middleW-45*Math.sqrt(3))+","+(middleH+70)+"L"+(middleW+45*Math.sqrt(3))+","+(middleH+70)+"Z"} strokeWidth="3"></path>
          <path style={transparent} ref="tr" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW+45*Math.sqrt(3))-20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="tl" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW-45*Math.sqrt(3))+20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="td" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+(middleW)+","+(middleH+94)} strokeWidth="3"></path>
         ...
         <div ref="weird4" style={style}  >
         <span style={{marginRight: '10px'}} className="pull-right">{this.props.data[3].date}  </span>
          <h1>{this.props.data[3].title}</h1>
          <a href={baseUrl+this.props.data[3].url}><svg height={height+25} version="1.1" width={width} xmlns="http://www.w3.org/2000/svg" style={{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}>
          <path style={transparent}  ref="triangle" stroke="#2c3e50" d={"M"+middleW+","+(middleH-55)+"L"+(middleW-45*Math.sqrt(3))+","+(middleH+70)+"L"+(middleW+45*Math.sqrt(3))+","+(middleH+70)+"Z"} strokeWidth="3"></path>
          <path style={transparent} ref="tr" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW+45*Math.sqrt(3))-20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="tl" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+((middleW-45*Math.sqrt(3))+20)+","+(middleH-7)} strokeWidth="3"></path>
          <path style={transparent} ref="td" stroke="#2c3e50" d={"M"+(middleW)+","+(middleH+25)+"L"+(middleW)+","+(middleH+94)} strokeWidth="3"></path>
...
var PostNode = React.createClass({
  //getInitialState: function() {
    //return {over: "no"}
 // },
 render: function() {
    return (
      <div className="postContent">
        ...
        />
        <a href={baseUrl+this.props.url}>read more</a>
