 ...
 // },
  componentDidMount: function() {
    ...
    this.props.weird.style.zIndex = 10;
        this.props.weird3.style.zIndex = 1;
        this.props.weird2.style.zIndex = 1;
        this.props.weird4.style.zIndex = 1;
    this.handleScroll();
  ...
  render: function() {
    ...
    var style = {background: 'url(/images/white.jpg)',
                 height: 401,
                 position: 'absolute',
    ...
    return (
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.div( {ref:"weird", style:style}  , 
          ...
          React.DOM.a( {href:baseUrl+this.props.data[0].url}, "Link to Post")
         ),
