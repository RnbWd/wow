    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining,
          React.DOM.input( {type:"text", style:{textAlign: "center", fontSize: "20px", fontWeight: "bold", marginLeft: "2%", marginRight: "2%"}, className:"form-control", value:this.state.title} ),
