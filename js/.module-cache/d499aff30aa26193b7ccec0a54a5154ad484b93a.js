...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    if (this.state.sha === '') {
      var commit = React.DOM.button( {onClick:this.handleAdd, className:"btn btn-primary pull-right"}, "Add Post")
    } else {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        newPost,
          React.DOM.span( {class:"title pull-left"}, 
          "Title: ", React.DOM.input( {type:"text", style:inputStyle, className:"bg-primary", onChange:  this.handleTitle, value:this.state.title} )
          ),
          commit
          ),
