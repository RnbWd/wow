...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenLite.to(banner, 30, {height: (400+total), force3D: true, useFrames: true});
  ...
  render: function() {
    ...
    var style = {background: 'grey',
                 ...
                 WebkitClipPath: 'polygon(\
                  ...
                  80% 90%, 100% 20px, 100% 50%,\
                  75% 100%, 25% 100%, 0 50%, 0 20px,\
                  30% 50%, 50% '+(middleH+25)+'px, 20% 20px\
                )'
               };
    ...
    return (
      React.DOM.div( {ref:"weird", className:"weird", onWheel:this.handleScroll}, 

        React.DOM.div( {className:"", style:style}  , 
        React.DOM.h1(null, "Coding Alchemy"),
        
        React.DOM.h4(null, "By ", React.DOM.a( {href:"https://github.com/rnbwd"}, "RnbWd"))
        
         ),
         React.DOM.svg( {ref:"svg", height:height, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0, top: 0, zIndex: 99}}, 
          ...
          React.DOM.circle( {style:transparent, cx:middleW+45*Math.sqrt(3), cy:middleH-17, r:"20", stroke:"#2c3e50", strokeWidth:"3"} ),
          React.DOM.circle( {style:transparent, cx:middleW-45*Math.sqrt(3), cy:middleH-17, r:"20", stroke:"#2c3e50", strokeWidth:"3"}),
          React.DOM.circle( {style:transparent, cx:middleW, cy:middleH+114, r:"20", stroke:"#2c3e50", strokeWidth:"3"})
        )
      )
    )
  }
