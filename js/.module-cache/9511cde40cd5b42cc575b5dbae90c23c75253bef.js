      ...
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.div( {ref:"weird", style:style}  , 
         ...
         React.DOM.span( {style:{marginRight: '10px'}, className:"pull-right"}, this.props.data[1].date,  "  "  ),
            ...
            React.DOM.svg( {ref:"svg", height:height+25, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}, 
