    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        newPost,
          ...
          React.DOM.input( {type:"text", id:"postTitle", className:"bg-primary", onChange:  this.handlePath, value:this.state.path} )
          ),
          commit,
          deletebtn
          ),
        ...
        React.DOM.nav( {className:"bottomNav bg-primary"} , 
          React.DOM.p( {className:""} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining, " Sha: ", this.state.sha, " " )
        )
