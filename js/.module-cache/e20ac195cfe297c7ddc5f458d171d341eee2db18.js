    ...
    if (event) {
      ...
      var doIt = function() {
       ...
       // window.requestAnimationFrame(self.update);
        ...
        var bannerTween2 = new TweenMax.to(confuse, 60, {rotation: (total), transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, useFrames: true});
  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll, onTouchMove:this.handleTouch}, 
        ...
        React.DOM.div( {style:style, className:"confuse hexa", ref:"confuse"}, 
          React.DOM.img( {style:style, ref:"comp", src:"images/cs.jpg"} )
        )
