...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  componentDidMount: function() {
    ...
    this.props.over = "no";
    weirdTween  = new TweenMax.to(td, 2, {rotation:360, repeat: -1, repeatDelay: 1, yoyo: true, transformOrigin:"50% 0% -400px", transformPerspective:500, delay: 3, force3D: true});
    weirdTween2  = new TweenMax.to(tl, 2, {rotation:360, repeat: -1, repeatDelay: 1, yoyo: true, transformOrigin:"100% 100% -400px", transformPerspective:500, delay: 3, force3D: true});
    weirdTween3  = new TweenMax.to(tr, 2, {rotation:360, repeat: -1, repeatDelay: 1, yoyo: true, transformOrigin:"0% 100% -400px", transformPerspective:500, delay: 3, force3D: true});
