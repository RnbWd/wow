...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  handleEdit: function(all) {
    ...
    outputTween = TweenLite.to(this.props.output, 0.5, {left: "51%", width: "48%", force3D: true});    var leftTween = TweenLite.to(this.props.leftLink, 0.5, {autoAlpha: 0.7, force3D: true});
  },
