  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.a( {href:"/", className:"btn pull-left"}, "Home"),
        all,
        edit,
        
        newPost,
          React.DOM.input( {type:"text", style:inputStyle, className:"form-control pull-left", onChange:  this.handleTitle, value:this.state.title} ),
          commit
          ),
        ...
        React.DOM.div( {className:"bottomNav bg-primary"} , 
          React.DOM.p( {className:"pull-left"} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining,  "  Date: ", this.state.year, " ", this.state.month, " ", this.state.day
          )
        )
