...
var Alchemy = React.createClass({displayName: 'Alchemy',
  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"weird", ref:"comp", style:{height: window.innerHeight}, onWheel:this.handleScroll, onTouchMove:this.handleTouch}, 
        ...
        React.DOM.img( {style:{height: 0, position: 'fixed', left: '30%', top: '15%', borderRadius: '50%'},  src:"images/cs.jpg"} )
      )
    )
  }
});
