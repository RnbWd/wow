...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var all = React.DOM.button( {style:inputStyle, onClick:this.handleAll, className:"btn btn-warning pull-left"}, "All Post")
    var newPost = React.DOM.button( {style:outputStyle, onClick:this.handleNew, className:"btn btn-primary btn-success pull-left"}, "New Post")
