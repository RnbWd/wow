...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  componentDidMount: function() {
    ...
    this.props.over = "no";
    weirdTween  =new TweenLite.to(triangle, 2, {transform: "translate(30) rotate(45 50 50)"});
  },
  update: function() {
    this.forceUpdate();
  },
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, 
        ...
        React.DOM.svg( {height:height, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{overflow: 'hidden', position: 'absolute', left: 0, top: 0}}, 
