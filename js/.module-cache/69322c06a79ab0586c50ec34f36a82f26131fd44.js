...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    if (this.state.sha === '') {
      var commit = React.DOM.button( {style:inputStyle, onClick:this.handleCommit, className:"btn btn-primary pull-right btn-warning"}, "Add Post")
    } else {
      var commit =  React.DOM.button( {style:inputStyle, className:"btn btn-primary pull-right btn-success", onClick:this.handleCommit}, "Commit")
