...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  getInitialState: function() {
    return {value: 'Type some *markdown* here!', github: '', path: '', signin: '', login: '', sha: ''};
  },
    ...
    $.ajax({
        type: "GET",
         ...
         success: function(response) {
          ...
          self.setState({value: atob(response.content), sha: response.sha});
         },
  ...
  handleCommit: function() {
    $.ajax({
        type: "PUT",
         ...
         datatype: "jsonp",
         data: JSON.stringify({"path": "/_posts/"+this.state.path, "message": "hello", "content": btoa(this.state.value), "sha": this.state.sha}),
         success: function(response) {
          console.log(response);
         },
         error: function(response) {
