  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        newPost,
          React.DOM.span( {style:inputStyle, className:"title bg-warning"}, 
        ...
        React.DOM.nav( {className:"bottomNav bg-primary"} , 
          React.DOM.p( {className:""} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining,  "  Date: ", this.state.year, " ", this.state.month, " ", this.state.day
          )
        )
