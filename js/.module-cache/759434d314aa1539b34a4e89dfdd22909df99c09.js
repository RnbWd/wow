    ...
    $.ajax({
        type: "GET",
         ...
         success: function(response) {
          ...
          var content = unescape( encodeURIComponent(response.content));
          var auto = atob(content);
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.p( {className:"navbar-text navbar-left"} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining),
        edit,
