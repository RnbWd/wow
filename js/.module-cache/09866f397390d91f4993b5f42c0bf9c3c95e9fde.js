...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  componentDidMount: function() {
    ...
    this.props.over = "no";
    weirdTween  =new TweenMax.to([tr, tl, td], 2, {rotation:180, repeat: -1, repeatDelay: 1, yoyo: true, transformOrigin:"50% 0% -400px", transformPerspective:500, delay: 3, force3D: true});
  },
  update: function() {
    this.forceUpdate();
  },
