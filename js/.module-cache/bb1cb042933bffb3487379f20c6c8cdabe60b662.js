...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var edit = React.DOM.button( {style:outputStyle, onClick:this.handleEdit, className:"btn btn-primary"}, "Edit Post")
    var all = React.DOM.button( {style:inputStyle, onClick:this.handleAll, className:"btn btn-primary"}, "All Post")
    var newPost = React.DOM.button( {style:outputStyle, onClick:this.handleNew, className:"btn btn-primary"}, "New Post")
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.a( {href:"/", className:"btn btn-primary"}, "Home"),
        all,
        edit,
