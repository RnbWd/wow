...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  getInitialState: function() {
    return {value: 'Type some *markdown* here!', github: '', path: '', signin: ''};
  },
    ...
    $.ajax({
        type: "GET",
         ...
         success: function(response) {
          ...
          self.setState({value: atob(response.content)});
         },
  ...
  render: function() {
    return (
      React.DOM.div( {className:"container-fluid brdr github"}, 
        React.DOM.div(null, 
        React.DOM.h2(null, "Authorization Code"),
          this.props.auth,
          this.props.btn 
        )
      )
