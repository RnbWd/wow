...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  handleEdit: function() {
    ...
    var navTween = TweenLite.to(this.props.nav, 1, {left: "-100%", force3D: true});
    var outputTween = TweenLite.to(this.props.output, 0.5, {left: "51%", width: "48%", force3D: true});
    //var inputTween = TweenLite.to(this.props.input, 0.5, {display: "block", auto force3D: true});
    var leftTween = TweenLite.to(this.props.leftLink, 0.5, {autoAlpha: 0.7, force3D: true});
  },
  ...
  render: function() {
    ...
    var commit =  React.DOM.button( {className:"btn btn-default navbar-btn submit", onClick:this.handleCommit}, "Commit")
    var edit = React.DOM.button( {onClick:this.handleEdit, className:"btn btn-default navbar-btn"}, "Edit Post")
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        edit,
        commit,
        React.DOM.p( {className:"navbar-text"} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining)
        ),
          React.DOM.input( {type:"text", style:{textAlign: "center", fontSize: "28px", fontWeight: "bold", marginLeft: "2%", width:"96%"}, className:"form-control", value:this.state.title} ),
