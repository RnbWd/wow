...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenMax.to(weird, 60, {rotationY: (total), rotationZ: total, transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, useFrames: true});
