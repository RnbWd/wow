      ...
      React.DOM.div(null, 
        React.DOM.div( {className:"panel panel-primary signin"}, 
          ...
          React.DOM.div( {className:"panel-body"}, 
            this.props.auth,
            this.props.btn,
            React.DOM.p(null, "Sign into Github. Click Account Settings " )
          )
        )
      )
    )
...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    if (this.state.sha === '') {
      var commit = React.DOM.button( {onClick:this.handleAdd, className:"btn btn-default navbar-btn navbar-right"}, "Add Post")
    } else {
      var commit =  React.DOM.button( {style:inputStyle, className:"btn btn-default navbar-btn navbar-right", onClick:this.handleCommit}, "Commit")

    }
    var auth = React.DOM.input( {type:"text", className:"form-control auth pull-left", value:github, onChange:this.handleAuth} )
    var name = React.DOM.input( {type:"text", className:"form-control", value:path, onChange:this.handleName} )
    var submit =  React.DOM.button( {type:"submit", className:"btn btn-default submit pull-left", onClick:this.handleSignin}, "Submit")
    var edit = React.DOM.button( {style:outputStyle, onClick:this.handleEdit, className:"btn btn-default navbar-btn navbar-left"}, "Edit Post")
    var all = React.DOM.button( {style:inputStyle, onClick:this.handleAll, className:"btn btn-default navbar-btn navbar-left"}, "All Post")
    var newPost = React.DOM.button( {style:outputStyle, onClick:this.handleNew, className:"btn btn-default navbar-btn navbar-left"}, "NEw Post")
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        newPost,
          React.DOM.input( {type:"text", style:{textAlign: "center", fontSize: "28px", fontWeight: "bold"}, className:"form-control navbar-form navbar-left", onChange:  this.handleTitle, value:this.state.title} ),
          commit
          ),
        ...
        React.DOM.div( {className:"bottomNav"} , 
