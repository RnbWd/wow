...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    if (this.state.sha === '') {
      var commit = React.DOM.button( {onClick:this.handleAdd, className:"btn btn-default navbar-btn navbar-left"}, "Add Post")
    } else {
    ...
    var add = React.DOM.button( {onClick:this.handleAdd, className:"btn btn-default navbar-btn navbar-left"}, "Add Post")
