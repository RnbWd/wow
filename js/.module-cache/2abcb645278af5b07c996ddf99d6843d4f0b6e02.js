...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      weirdTween  = new TweenMax.to(td, 50, {rotation: (360), transformOrigin:"50% 0% -400px", transformPerspective:500, force3D: true, useFrames:true});
      weirdTween50  = new TweenMax.to(tl, 50, {rotation: (360), transformOrigin:"100% 100% -400px", transformPerspective:500, force3D: true, useFrames:true});
      weirdTween3  = new TweenMax.to(tr, 50, {rotation: (360),  transformOrigin:"0% 100% -400px", transformPerspective:500, force3D: true, useFrames:true});
