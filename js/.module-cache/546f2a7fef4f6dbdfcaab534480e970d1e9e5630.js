...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenLite.to(weird, 60, {height: (window.innerHeight+total), force3D: true, useFrames: true});
  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.span( {style:{width:'100%', height:'100%', zIndex:-101, position: 'fixed', left: 0, top:0}}, 
        React.DOM.video( {width:"100%", height:"100%", autoPlay:true, loop:true},  " //EDIT: loop=\"true\" is deprecated nowadays",
          React.DOM.source( {src:"images/the_big_bad_wolf.ogv", type:"video/ogg"} ),
          React.DOM.source( {src:"images/the_big_bad_wolf.mp4", type:"video/mp4"} ),
