    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.p( {className:"navbar-text"} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining),
          ...
          React.DOM.input( {type:"text", style:{textAlign: "center", fontSize: "28px", fontWeight: "bold", marginLeft: "2%", width:"96%"}, className:"form-control navbar", value:this.state.title} )
          ),
