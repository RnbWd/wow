...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var home = React.DOM.button( {className:"btn btn-default pull-left", onClick:  this.handleHome} , "Home")
    ...
    var postTitle = React.DOM.input( {type:"text", id:"postTitle", className:"bg-primary", onChange:  this.handlePathInput, value:this.state.path} )
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.textarea( {onChange:this.handleLayout, className:"layout", value:this.state.layout} ),
          React.DOM.textarea(
            {className:"markdown",
