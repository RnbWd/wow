...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.a( {href:"/", className:"btn btn-default pull-left"}, "Home"),
        all,
        newPost,
  ...
  handleAll: function() {
    if (this.state.changed == 'changed') {
      if (confirm("This file ain't be saved fool.")) {
  ...
  handleScrolls: function(event) {
    if (this.props.output.scrollHeight > event.target.scrollHeight) {
      event.target.scrollHeight = this.props.output.scrollHeight;
    }
    this.props.output.scrollTop = event.target.scrollTop;
    console.log(this.props.output.scrollHeight);
    console.log(this.props.output.clientHeight);
