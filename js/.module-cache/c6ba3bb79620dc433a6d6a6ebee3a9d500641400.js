  ...
  render: function() {
    return (
      ...
      React.DOM.svg( {height:"300", version:"1.1", width:"1160", xmlns:"http://www.w3.org/2000/svg", style:"overflow: hidden; position: absolute; left: 35px; top: 21px; -webkit-transform: matrix(1, 0, 0, 1, 0, 0);"}, 
        ...
        React.DOM.path( {fill:"#d3d3d3", stroke:"#2c3e50", d:"M580,175L637.9422863405995,143", strokeWidth:"3"}),
        React.DOM.path( {fill:"#d3d3d3", stroke:"#2c3e50", d:"M580,175L522.0577136594005,143", strokeWidth:"3"}),
        React.DOM.path( {fill:"#d3d3d3", stroke:"#2c3e50", d:"M580,175L580,244", strokeWidth:"3"}),
