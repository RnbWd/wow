...
var Alchemy = React.createClass({displayName: 'Alchemy',
  render: function() {
    return (
      React.DOM.div(null, 
      React.DOM.svg( {height:rect.height, version:"1.1", width:rect.width, xmlns:"http://www.w3.org/2000/svg", style:{overflow: 'hidden', position: 'absolute', left: '35px', top: '21px'}}, 
