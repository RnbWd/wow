...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      weirdTween  = new TweenMax.to(td, 50, {rotation: (event.deltaY), yoyo: true, transformOrigin:"50% 0% -400px", transformPerspective:500, force3D: true, useFrames:true, immediateRender:true});
      weirdTween50  = new TweenMax.to(tl, 50, {rotation: (event.deltaY), yoyo: true, transformOrigin:"100% 100% -400px", transformPerspective:500, force3D: true, useFrames:true, immediateRender:true});
      weirdTween3  = new TweenMax.to(tr, 50, {rotation: (event.deltaY), yoyo: true, transformOrigin:"0% 100% -400px", transformPerspective:500, force3D: true, useFrames:true, immediateRender:true});
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {style:{position: 'fixed'}, onWheel: this.handleScroll}, 
