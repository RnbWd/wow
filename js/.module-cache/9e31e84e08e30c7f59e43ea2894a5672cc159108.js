 ...
 // },
  ...
  handleScroll: function(event) {
          ...
          setTimeout(function() {
            ...
            if ((total%90 + total)%90 === 0) {
              ...
              if (comp === '25') {
                ...
                weird3.style.zIndex = 1;
                weird2.style.zIndex = 1;
                weird.style.zIndex = 1;
                //console.log(total);
              }
              else if (comp === '5') {
                console.log('180');
                weird3.style.zIndex = 10;
                weird4.style.zIndex = 1;
                weird2.style.zIndex = 1;
                weird.style.zIndex = 1;
      ...
      var doIt = function() {
        ...
        var bannerTween = new TweenMax.to(weird, 60, {rotationY: (total), rotationZ: total, transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, onComplete: snap(), useFrames: true});
         var bannerTween2 = new TweenMax.to(weird2, 60, {rotationY: (total+90), rotationZ: total, transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, useFrames: true});
          var bannerTween3 = new TweenMax.to(weird3, 60, {rotationY: (total+180), rotationZ: total, transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, useFrames: true});
         var bannerTween4 = new TweenMax.to(weird4, 60, {rotationY: (total+270), rotationZ: total,transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, useFrames: true});
      }
      doIt();
    ...
    return (
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.h4(null, "By ", React.DOM.a( {href:"https://github.com/rnbwd"}, "RnbWd"))
         ...
         React.DOM.svg( {ref:"svg", height:height+25, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0, top: 0, zIndex: -1 }}, 
