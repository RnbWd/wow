  ...
  render: function() {
    ...
    return (
      React.DOM.div( {onWheel: this.handleScroll}, 
        ...
        React.DOM.img( {style:{WebkitClipPath: 'url(#c1) repeat -200px -200px'}, className:"target", src:baseUrl+"images/fractal.jpg", width:"568"} ),
        React.DOM.svg( {ref:"svg", height:height, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0, top: 0}}, 
          ...
          React.DOM.circle( {fill:"url(#image)", cx:middleW+45*Math.sqrt(3), cy:"135", r:"20", stroke:"#2c3e50", strokeWidth:"3"} ),
