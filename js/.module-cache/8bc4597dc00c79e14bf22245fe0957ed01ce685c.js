      ...
      React.DOM.div( {className:"weird"} , 
        ...
        React.DOM.h4(null, "By ", React.DOM.a( {href:"https://github.com/rnbwd"}, "RnbWd"))
         ...
         React.DOM.svg( {ref:"svg", height:height, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0, top: 0, zIndex: 99}}, 
          ...
          React.DOM.circle( {style:transparent, cx:middleW+45*Math.sqrt(3), cy:"155", r:"20", stroke:"#2c3e50", strokeWidth:"3"} ),
          React.DOM.circle( {style:transparent, cx:middleW-45*Math.sqrt(3), cy:"155", r:"20", stroke:"#2c3e50", strokeWidth:"3"}),
          React.DOM.circle( {style:transparent, cx:middleW, cy:"282", r:"20", stroke:"#2c3e50", strokeWidth:"3"})
        )
      )
    )
  }
