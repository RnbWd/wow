    ...
    return (
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.div( {ref:"weird", style:style}  , 
          React.DOM.span( {className:"pull-right"}, this.props.data[0].date,  "  "  ),
          React.DOM.h1(null, this.props.data[0].title)
        
         ),
         React.DOM.div( {ref:"weird2", style:style}  , 
         React.DOM.span( {className:"pull-right"}, this.props.data[1].date,  "  "  ),
            React.DOM.h1(null, this.props.data[1].title)

        
         ),
         React.DOM.div( {ref:"weird3", style:style}  , 
         React.DOM.span( {className:"pull-right"}, this.props.data[2].date,  "  "  ),
           React.DOM.h1(null, this.props.data[2].title)
        
         ),
         React.DOM.div( {ref:"weird4", style:style}  , 
         React.DOM.span( {className:"pull-right"}, this.props.data[3].date,  "  "  ),
