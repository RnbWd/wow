  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"weird",  style:{height: window.innerHeight}, onWheel:this.handleScroll, onTouchMove:this.handleTouch}, 
       React.DOM.h3( {style:{position: 'fixed', zIndex: 30, textAlign: 'center'}} , "Much Scroll"),
        React.DOM.div( {className:"shibe", style:{position: 'fixed', zIndex: 35, textAlign: 'center'}, ref:"weird"} , 
          React.DOM.h3(null, "Much Scroll")
        ),
