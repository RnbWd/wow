  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        React.DOM.span( {style:{width:'100%', height:'100%', zIndex:0, position: 'fixed', left: 0, top:0}}, 
        React.DOM.video( {width:"100%", height:"100%", autoplay:"autoplay", loop:true},  " //EDIT: loop=\"true\" is deprecated nowadays"+' '+
          "/*",React.DOM.source( {src:"movie.mp4", type:"video/mp4"} ),
          React.DOM.source( {src:"movie.ogg", type:"video/ogg"} ),"*/"+' '+
