...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  getInitialState: function() {
    return {value: 'Type some *markdown* here!', github: '', path: '', signin: '', login: '', sha: '', limit: '', remaining: '', layout: ''};
  },
  ...
  handleCommit: function() {
    ...
    $.ajax({
        type: "PUT",
         ...
         datatype: "jsonp",
         data: JSON.stringify({"path": this.state.path, "message": "hello", "content": btoa("---"+this.state.layout+"---"+this.state.value), "sha": this.state.sha}),
         success: function(response) {
          console.log(response);
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"container-fluid brdr"}, 
        ...
        React.DOM.p(null, this.state.layout),
