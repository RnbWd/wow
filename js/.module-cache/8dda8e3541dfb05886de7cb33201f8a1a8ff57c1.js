...
var Alchemy = React.createClass({displayName: 'Alchemy',
  ...
  render: function() {
    ...
    return (
      React.DOM.div(  {className:"weird", ref:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll, onTouchMove:this.handleTouch}, 
        React.DOM.div( {className:"shibe"} 
