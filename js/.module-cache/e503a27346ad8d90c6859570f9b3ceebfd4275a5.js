...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  render: function() {
    ...
    var grey = {fill: 'grey'};
    var svg = (React.DOM.svg( {height:height+25, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0-(window.innerWidth - 401)/2, top: 0}}, 
