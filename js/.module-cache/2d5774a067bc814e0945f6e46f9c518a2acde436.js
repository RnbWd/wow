...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  getInitialState: function() {
    return {value: 'Type some *markdown* here!', github: auth.first().get('token'), path: '', signin: '', login: '', sha: '', limit: '', remaining: '', layout: ''};
  },
  componentDidMount: function() {
     (this.state.github != '') ? this.setState({signin: 'in'}) : '';
  },
