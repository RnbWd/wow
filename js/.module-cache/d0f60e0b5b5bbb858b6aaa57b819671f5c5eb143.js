...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  handleClick: function() {
    $.ajax({
        type: "PUT",
         url: "https://api.github.com/repos/RnbWd/portfolio/contents/hello.txt",
         headers: {
          Authorization: "token <insert token>"
         },
         datatype: "jsonp",
         data: JSON.stringify({"path": 'hello.txt', "message": "hello", "content": btoa('hello')}),
  ...
  render: function() {
    ...
    var auth = React.DOM.input( {type:"text", className:"form-control", value:github, onChange:this.handleInput} )
    var name = React.DOM.input( {type:"text", className:"form-control", value:github, onChange:this.handleInput} )
