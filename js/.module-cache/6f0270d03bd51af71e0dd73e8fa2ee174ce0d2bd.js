 ...
 // },
  render: function() {
    var postNodes = this.props.data.map(function (post) {
      return PostNode( {title:post.title, date:post.date, url:post.url, content:_.template($( "'script.template"+post.index+"'").html())} );
    });
    return (
      ...
      React.DOM.div( {className:"postContent"}, 
        ...
        React.DOM.div(
          ...
          dangerouslySetInnerHTML:{
            __html: marked(this.props.content.toString())
          }}
        ),
