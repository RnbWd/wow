  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:""}, 
        ...
        React.DOM.p( {className:"pull-left"} , "Logged in as: ", login, " Limit: ", this.state.limit, " Remaining: ", this.state.remaining),
        all,
        edit,
        
        newPost,
          React.DOM.input( {type:"text", style:inputStyle, className:"form-control navbar-form navbar-left", onChange:  this.handleTitle, value:this.state.title} ),
          commit
          ),
