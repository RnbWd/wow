...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  handleNew: function() {
    this.setState({edit: 1, title: "New Post", value: "New *markdown* post", layout: "layout: post \n picture: /images/fractal.jpg", path: "", sha: "", year: new Date().getFullYear(), month: (new Date().getMonth()+1), day: new Date().getDay()});
    this.props.input = this.refs.input.getDOMNode();
    this.props.output = this.refs.output.getDOMNode();
  ...
  render: function() {
    ...
    var newPost = React.DOM.button( {onClick:this.handleNew, className:"btn btn-default navbar-btn navbar-left"}, "NEw Post")
