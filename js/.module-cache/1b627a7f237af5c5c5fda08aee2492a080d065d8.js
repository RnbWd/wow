...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var all = React.DOM.button( {style:inputStyle, onClick:this.handleAll, className:"btn"}, "All Post")
    var newPost = React.DOM.button( {style:outputStyle, onClick:this.handleNew, className:"btn"}, "NEw Post")
