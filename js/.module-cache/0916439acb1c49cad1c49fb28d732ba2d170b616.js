...
var Alchemy = React.createClass({displayName: 'Alchemy',
 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenMax.to(weird, 60, {height: (window.innerHeight+total), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
