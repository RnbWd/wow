...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var edit = React.DOM.button( {style:outputStyle, onClick:this.handleEdit, className:"btn btn-default navbar-btn btn-small navbar-left"}, "Edit Post")
    var all = React.DOM.button( {style:inputStyle, onClick:this.handleAll, className:"btn btn-default navbar-btn btn-small navbar-left"}, "All Post")
    var newPost = React.DOM.button( {style:outputStyle, onClick:this.handleNew, className:"btn btn-default navbar-btn btn-small navbar-left"}, "NEw Post")
