 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenMax.to(weird, 60, {rotationY: (total), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
       var bannerTween2 = new TweenMax.to(weird2, 60, {rotationX: (total), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
    ...
    return (
      React.DOM.div(  {className:"weird", style:{height: window.innerHeight}, onWheel:this.handleScroll}, 
        ...
        React.DOM.h4(null, "By ", React.DOM.a( {href:"https://github.com/rnbwd"}, "RnbWd"))
         ...
         React.DOM.svg( {ref:"svg", height:height+25, version:"1.1", width:width, xmlns:"http://www.w3.org/2000/svg", style:{position: 'absolute', left: 0, top: 0, zIndex: 99, transformPerspective: -400}}, 
