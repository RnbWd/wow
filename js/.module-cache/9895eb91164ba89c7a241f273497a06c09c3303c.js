 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var doIt = function() {
        ...
        var bannerTween = new TweenMax.to(weird, 60, {rotationY: (total+360), rotationZ: total, transformOrigin:"50% 50% -200px", transformPerspective:400, force3D: true, onComplete: snap(), useFrames: true});
