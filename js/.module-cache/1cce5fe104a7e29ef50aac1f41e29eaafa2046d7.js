...
var MarkdownEditor = React.createClass({displayName: 'MarkdownEditor',
  ...
  render: function() {
    ...
    var all = React.DOM.button( {onClick:this.handleEdit('all'), className:"btn btn-default navbar-btn navbar-left"}, "All Post")
