 ...
 // },
  ...
  handleScroll: function(event) {
      ...
      var bannerTween = new TweenMax.to(weird, 60, {rotationY: (total), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
       var bannerTween2 = new TweenMax.to(weird2, 60, {rotationY: (total+180), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
       ...
       var bannerTween4 = new TweenMax.to(weird4, 60, {rotationY: (total+180), transformOrigin:"50% 50% -400px", transformPerspective:500, force3D: true, useFrames: true});
